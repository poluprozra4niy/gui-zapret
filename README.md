...
Нажмите кнопку **▶ (Включить)** для активации обхода блокировок.

### 3. Проверка

Используйте кнопку **🔍Найти стратегии** для проверки доступности сервисов.
...
| Функция | Описание |
|---------|----------|
| **Установить сервис** | Установка Zapret как Windows-службы |
| **Удалить сервис** | Удаление службы |
| **Диагностика** | Запуск диагностики сети |
| **Запустить тесты** | Тестирование всех стратегий |
| **Игровой фильтр** | Фильтрация игрового трафика |
| **Автозапуск** | Запуск приложения при старте системы |
| **Настройки сети DNS** | Настройка DNS over HTTPS |

### Настройка DNS over HTTPS

1. Перейдите на вкладку **Дополнительно**
2. Проскрольте до **Менеджер DNS**
